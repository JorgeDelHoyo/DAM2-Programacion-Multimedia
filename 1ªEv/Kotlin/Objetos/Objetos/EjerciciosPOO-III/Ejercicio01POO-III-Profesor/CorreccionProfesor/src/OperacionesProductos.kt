...
sealed class OperacionesProductos{
    data class Agregar(val p : Producto)
    data class Eliminar(val idprod: Int) : OperacionesProductos()
    data class Actualizar(val idprod: Int, val precio : Double) : OperacionesProductos()
}