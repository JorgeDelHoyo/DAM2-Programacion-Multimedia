...
// Usuario (Administrador, moderador, usuario)
// --> ID, Nombre, correoElectronico
// --> Validar correos (email@email.com)
// --> Validar cuenta valida (nombre[3-20car] solo alfanumericos y caracter _
// --> Autenticar usuario (depende del usuario)
// Iniciar sesion
// -->
