...
sealed class Inventario {
    data class Agregar(val nombre: String, val precio: Double) : Inventario()
    data class Eliminar(val id: Int) : Inventario()
    data class Actualizar(val id: Int, val nuevoNombre: String, val nuevoPrecio: Double) : Inventario()
}
